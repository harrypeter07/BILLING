      ...
      <div className="grid gap-4 md:gap-6 md:grid-cols-3">
        <Card>
          ...
          <CardContent className="space-y-3">
            ...
            {(invoice.created_by_employee_id || invoice.employee_id || invoiceData?.employees) && (
              <div className="flex justify-between pt-2 border-t">
                <span className="text-muted-foreground">Generated By:</span>
                <span className="font-medium">
                  {invoiceData?.employees?.name || invoice.created_by_employee_id || invoice.employee_id || "Admin"}
                </span>
              </div>
            )}
            ...
            {customer ? (
              <>
                ...
                <div className="flex justify-between">
                  ...
                  <span className="font-medium break-all text-right">{customer.email || "N/A"}</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-muted-foreground">Billing Address:</span>
                  <span className="font-medium text-right">{customer.billing_address || customer.address || "N/A"}</span>
                </div>
                {(isB2BEnabled || customer.gstin) && (
                  <div className="flex justify-between">
                    <span className="text-muted-foreground">GSTIN:</span>
                    <span className="font-medium">{customer.gstin || "N/A"}</span>
                  </div>
                )}
                {customer.city && (
                  <div className="flex justify-between">
